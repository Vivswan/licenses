...
<https://github.com/Vivswan/licenses/blob/main/individual-small-organization-license/1.0.0/LICENSE.md>

Required Notice: Copyright [copyright holder and contact]
...
both strict obligations and conditions to all your licenses. An
...
The licensor grants you a copyright license to do everything you might
...
The licensor grants a [small organization](#definitions) that agrees to
these terms a copyright license to do everything with the software that
would otherwise infringe the licensor's copyright in it, but only for
the organization's internal operations, subject to the limits below: its
own administration and the development and operation of its own
products, services, and systems. Internal operations do not include
producing deliverables for others, providing the software or its
functionality to others, or running the software within a product or
service offered to others. Operating the organization's own products and
services remains internal even when they are offered to others, so long
as what is offered does not include the software, its functionality, or,
beyond the output licensed below, its expression.

Using the software as designed is licensed: the organization may
configure the software and generate, keep, use, and publish the
software's output for its own repositories and systems, even where that
output carries the software's expression. Nothing more is granted: the
organization may not otherwise change the software or make new works
based on it, may not distribute it, and may not offer it - or, except
for output licensed above, anything carrying its expression - to others.
Products and services the organization builds and offers that contain
...
is within the wind-down below. At each use, headcount and group
composition are counted as they then stand, and income is counted as the
small organization definition provides. An organization stops qualifying
on the first day the group no longer meets the definition - by growth,
acquisition, merger, or otherwise - and keeps this license for 90 days
from that day, to obtain a separate license from the licensor or stop
using the software. Use within that wind-down is licensed and is not a
violation of these terms. A group can rely on this wind-down only once
in any 36 months, counting the wind-downs of every organization that is
or becomes part of the group.

This section, the output license in the [Individual
License](#individual-license), and [Service
Providers](#service-providers) are the only copyright licenses the
licensor grants an organization under these terms; apart from that
output license, the [Individual License](#individual-license), the
[Changes and New Works License](#changes-and-new-works-license), and the
[Distribution License](#distribution-license) are granted to natural
persons only.

## Changes and New Works License

The licensor grants you an additional copyright license to make changes
and new works based on the software - including maintaining a fork on a
source-hosting platform - for the same purposes and under the same
conditions as the [Individual License](#individual-license).

## Distribution License

The licensor grants you an additional copyright license to share copies
of the software, and of changes and new works based on it, only under
these same terms and with the notices required below. You may not offer
the software, or anything built on it, to others under any other terms
without the licensor's written permission.

## Downstream Recipients

Everyone who gets the software, or changes and new works based on it,
from you gets their licenses directly under these terms: from the
licensor for the software, and from each author for that author's
changes and new works. For changes and new works an author shares under
these terms, the [Patent License](#patent-license), [Patent
Defense](#patent-defense), [No Liability](#no-liability), and [No Other
Rights](#no-other-rights) sections apply with that author as the
licensor and those changes and new works as the software. You may not
grant licenses of your own.

## Service Providers

These terms also allow any service provider - a source-hosting platform,
mirror, package registry, or network - to host, store, cache, transmit,
...
Changes and new works you author are your own copyright. When they
contain none of the software's copyrightable expression - neither the
licensor's nor other authors' - they are entirely yours, under any terms
you choose. Combined with any part of the software, they may be shared
only as the [Distribution License](#distribution-license) allows.

## Relicensing by Permission

The licensor may, by written permission, allow a fork or new work based
on the software to be offered under different terms. That permission
covers the licensor's copyright and everything the licensor may
relicense - including contributions received under
[Contributions](#contributions) - so a fork also needs the agreement of
...
offered under these terms for inclusion in the software - a pull
request, a patch, or code you offer in an issue or review for inclusion,
whether or not it is accepted - and unless you conspicuously state when
you submit it that it is not a contribution, you, and any organization
on whose behalf you submit or that has authorized your submission, grant
the licensor a non-exclusive, perpetual, irrevocable, worldwide,
royalty-free, transferable license: under copyright, to reproduce,
modify, prepare derivative works of, publicly display, publicly perform,
distribute, sublicense, and relicense the contribution, alone or as part
of the software or any other work, under any terms, including commercial
terms; and under any licensable patent claims that the contribution
infringes, alone or as part of the software or any other work, to make,
...
terms, and your grant and representation here do not cover it. You
represent that you are entitled to grant these licenses, and that any
organization holding rights in the contribution has authorized you to
grant them on its behalf.

## Organizations

Beyond the [Small Organization License](#small-organization-license),
the [Service Providers](#service-providers) section, and the output
license in the [Individual License](#individual-license), the licensor
grants organizations no further copyright licenses under these terms. No
corporation, company, partnership, nonprofit, charity, educational
institution, government body, or other organization gets any further
right under these terms to use, deploy, integrate, distribute, or
...
provided with the software. This section does not apply to output as
such, even where the output carries the software's expression.
...
would be infringed by anything these terms allow you to do with the
software.
...
behalf of, any of those organizations.
...
to anyone else. These terms do not imply any other licenses, and grant
no rights in the licensor's trademarks or names. A platform through
which the licensor makes the software available may grant you rights
under its own terms - such as viewing or forking a public repository
through that platform's functionality. Those rights come from the
platform's terms alone, reach no further than they provide, and do not
expand your licenses under these terms.

## Violations

If you are notified in writing that you have violated any of these
terms, or done anything with the software not covered by your licenses,
and you received no such notice in the preceding 36 months, your
...
the [Small Organization License](#small-organization-license), [Service
Providers](#service-providers), and [Contributions](#contributions)
sections provide; **your** has the corresponding meaning. Which licenses
each "you" receives is set by the license sections themselves.
